-- Update timer randomization from 10-20 seconds to 6-10 seconds

-- Update submit_word function to use 6-10 second timer
...
BEGIN
  ...
  -- UPDATED: Randomize timer between 6-10 seconds
  v_timer_duration := 6 + floor(random() * 5)::int;
...
-- Update handle_timeout function to use 6-10 second timer
...
-- Update start_new_game function to use 6-10 second timer
...
BEGIN
  ...
  -- Reset all players to alive/3 lives for a fresh round
  UPDATE players
  SET lives = 3,
      is_alive = true
