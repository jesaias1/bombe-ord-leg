...
export const GameRoom = () => {
      ...
      <div className="ob-game-shell">
        <div className="ob-game-main">
          <div className="text-center space-y-3">
            ...
            <h2 className="text-xl font-bold text-white">Rum ikke fundet</h2>
            <p className="text-slate-500 text-sm">Dette rum eksisterer ikke.</p>
          </div>
        </div>
      </div>
    );
  ...
  const isPlaying = eff?.status === 'playing';
  ...
  return (
    <div className="ob-game-shell">
      ...
      {/* Bottom input dock — only during gameplay */}
      {isPlaying && (
        <div className="ob-input-dock">
