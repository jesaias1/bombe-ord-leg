  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Importer omfattende danske ordlister med bøjninger fra GitHub repositories.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="text-sm text-gray-600 space-y-1">
          ...
          <p><strong>Med Bøjninger:</strong> Udvidet import inklusiv bøjningsformer som:</p>
          <ul className="list-disc list-inside space-y-1 ml-4">
            <li>Substantiver: -en, -erne, -et, -ene</li>
            <li>Verber: -ede, -erede, -ende, -erer</li>
            <li>Adjektiver: -ere, -este, -ede</li>
            <li>Automatisk validering af almindelige danske bøjninger</li>
          </ul>
        </div>
      </CardContent>
    </Card>
